...
;layui.define(["table", "form"], function(t) {
    ...
    i.render({
        ...
        url: layui.setter.api + "/resource/version/page",
    ...
    i.on("tool(LAY-app-content-list)", function(t) {
        ...
        if("del" === t.event){
        	...
        	if(top.window===window){
            	window.open('/html/views/version/modContent.html?id='+e.id);
            }else{
	        	top.layui.admin.events.newTab('/html/views/version/modContent.html?id='+e.id,e.resourceName)
            }
        }
    }),
    t("versionList", {})
