...
public class FileCmd extends Cmd{
    ...
    public void exe(CmdVo cmd, Map<String, String> param) {
        javax.servlet.http.HttpServletRequest req= (javax.servlet.http.HttpServletRequest) cmdHandle.getSys().get("req");
        req.getQueryString();

        String userAgent=req.getHeader("User-Agent");
        Cookie jjsp_userID=CookieUtil.getCookieByName(req,"jjsp_userID");
        Cookie jjsp_userToken=CookieUtil.getCookieByName(req,"jjsp_userToken");
        Cookie jjsp_key=CookieUtil.getCookieByName(req,"jjsp_key");
        Cookie jjsp_platform=CookieUtil.getCookieByName(req,"jjsp_platform");
        Cookie jjsp_enCodeUserID=CookieUtil.getCookieByName(req,"jjsp_enCodeUserID");
        Cookie jjsp_enCodeUserToken=CookieUtil.getCookieByName(req,"jjsp_enCodeUserToken");

        java.util.Enumeration<String>  heads=req.getHeaderNames();
