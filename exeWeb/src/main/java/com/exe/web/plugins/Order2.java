...
public class Order2 extends Cmd{
...
//        String name, String value, String path, Date expiry
        ...
        Cookie cookie=new Cookie("jjsp_userID","YB4703607@ITV","/",d);
        driver.manage().addCookie(cookie);
        cookie=new Cookie("jjsp_userToken","AnoAdAnoAd0DUSmue91YNKqfvXA1LeEn","/",d);
        driver.manage().addCookie(cookie);
        cookie=new Cookie("jjsp_key","5%3A2","/",d);
        driver.manage().addCookie(cookie);
        cookie=new Cookie("jjsp_platform","2","/",d);
        driver.manage().addCookie(cookie);
        cookie=new Cookie("jjsp_enCodeUserID","TVGB5245WD29.","/",d);
        driver.manage().addCookie(cookie);
        cookie=new Cookie("jjsp_enCodeUserToken","lGcN/CVxdsIPW37gsoQWB2bCmp%3FClq%3Ff","/",d);
        driver.manage().addCookie(cookie);
